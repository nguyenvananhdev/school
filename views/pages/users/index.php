        ...
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>Dữ liệu tất cả người dùng</h3>
                </div>
                <div class="dropdown">
                    ...
                    <table class="table display data-table text-nowrap dataTable no-footer" id="DataTables_Table_0" role="grid">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="even">
                                ...
                                <td class="text-center"><img src="img/figure/student3.png" alt="student">
                                </td>
                                <td>Jessia Rose</td>
                                <td>Female</td>
                                <td>1</td>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="text-center"><img src="img/figure/student4.png" alt="student">
                                </td>
                                <td>Mark Willy</td>
                                <td>Male</td>
                                <td>2</td>
                            ...
                            <tr role="row" class="even">
                                ...
                                <td class="text-center"> <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/school/public/images/student11.png" alt="logo">
                                </td>
                                <td>Jessia Rose</td>
                                <td>Female</td>
                                <td>1</td>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="text-center"><img src="img/figure/student6.png" alt="student">
                                </td>
                                <td>Mark Willy</td>
                                <td>Male</td>
                                <td>2</td>
                            ...
                            <tr role="row" class="even">
                                ...
                                <td class="text-center"><img src="img/figure/student7.png" alt="student">
                                </td>
                                <td>Jessia Rose</td>
                                <td>Female</td>
                                <td>1</td>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="text-center"><img src="img/figure/student8.png" alt="student">
                                </td>
                                <td>Mark Willy</td>
                                <td>Male</td>
                                <td>2</td>
